        ...
        <form name="form1" id="form1" method="post" action="<!--{$smarty.const.ROOT_URLPATH}-->shopping/deliv.php">
            ...
            <!--{if $smarty.const.USE_MULTIPLE_SHIPPING !== false}-->
                ...
                <div class="bubbleBox">
                    <div class="bubble_announce clearfix">
                        <p class="fb"><a href="javascript:eccube.setModeAndSubmit('multiple', '', '');">複数のお届け先に送りますか？</a></p>
                    </div>
            ...
            <div class="formBox">
                    ...
                    <dl class="deliv_check">
                        ...
                        <!--{else}-->
                            <dt>
                                ...
                                <ul class="edit">
                                    <li><a href="javascript:void(0);" onclick="eccube.openWindow('<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php?page=<!--{$smarty.server.SCRIPT_NAME|h}-->&amp;other_deliv_id=<!--{$arrAddr[cnt].other_deliv_id}-->','new_deiv','600','640'); return false;" class="b_edit">編集</a></li>
                ...
                <!--{if $tpl_addrmax < $smarty.const.DELIV_ADDR_MAX}-->
                    <div class="inner">
                        <a href="javascript:void(0);" onclick="eccube.openWindow('<!--{$smarty.const.ROOT_URLPATH}-->mypage/delivery_addr.php?page=<!--{$smarty.server.SCRIPT_NAME|h}-->','new_deiv','600','640'); return false;" class="btn_sub addbtn">新しいお届け先を追加</a>
                    </div>
                <!--{/if}-->
            </div><!-- /.formBox -->

            <ul class="btn_btm">
                <li><a href="javascript:eccube.setModeAndSubmit('customer_addr','','');" class="btn">選択したお届け先に送る</a></li>
