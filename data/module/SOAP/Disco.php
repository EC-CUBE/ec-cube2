...
{
    public $namespaces = [SCHEMA_WSDL => 'wsdl', SCHEMA_SOAP => 'soap'];
    public $import_ns = [];
    public $wsdl = '';
    public $disco = '';
    public $_wsdl = [];
    ...
    public $_service_ns = '';
    public $_service_desc = '';
    public $_portname = '';
    public $_bindingname = '';
    public $soap_server = null;

    public function __construct($soap_server, $service_name, $service_desc = '',
        $import_ns = null)
    {
    ...
    public function _generate_WSDL()
    {
        ...
        $this->_wsdl['definitions']['types']['schema'] = [];

        // Placeholder for messages
        $this->_wsdl['definitions']['message'] = [];
    ...
    public function &_getSchema($namespace)
    {
        // SCHEMA
    ...
    public function addSchemaFromMap(&$map)
    {
        if (!$map) {
            return;
        }
    ...
    public function addMethodsFromMap(&$map, $namespace, $classname = null)
    {
        if (!$map) {
            return;
        }
    ...
    public function _generate_DISCO_XML($disco_array)
    {
    ...
    public function _generate_WSDL_XML()
    {
    ...
    public function _arrayToNode($node_name = '', $array)
    {
        $return = '';
        if (is_array($array)) {
    ...
    public function _ifComplexTypeExists($typesArray, $type_name)
    {
