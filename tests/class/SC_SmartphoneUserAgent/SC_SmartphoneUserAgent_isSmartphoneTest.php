...
class SC_SmartphoneUserAgent_isSmartphoneTest extends Common_TestCase
{
     ...
     */
    public function testIPhone($ua)
    {
        $_SERVER['HTTP_USER_AGENT'] = $ua;
        $this->assertTrue($this->su->isSmartphone());
    }
     ...
     */
    public function testIPad($ua)
    {
        $_SERVER['HTTP_USER_AGENT'] = $ua;
        $this->assertFalse($this->su->isSmartphone());
    }
     ...
     */
    public function testWindowsPhone($ua)
    {
        $_SERVER['HTTP_USER_AGENT'] = $ua;
        $this->assertTrue($this->su->isSmartphone());
    }
    ...
    public function windowsPhoneProvider()
    {
        return [
            ...
            ['Mozilla/4.0 (compatible; MSIE 6.0; Windows CE; IEMobile 8.12; MSIEMobile 6.0) WS027SH'],
        ];
    }
     ...
     */
    public function testAndroid($ua)
    {
        $_SERVER['HTTP_USER_AGENT'] = $ua;
        $this->assertTrue($this->su->isSmartphone());
    }
     ...
     */
    public function testAndroidTablet($ua)
    {
        $_SERVER['HTTP_USER_AGENT'] = $ua;
        $this->assertFalse($this->su->isSmartphone());
    }
     ...
     */
    public function testBlackBerry($ua)
    {
        $_SERVER['HTTP_USER_AGENT'] = $ua;
        $this->assertTrue($this->su->isSmartphone());
    }
