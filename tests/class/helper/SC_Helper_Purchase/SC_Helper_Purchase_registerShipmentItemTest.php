...
class SC_Helper_Purchase_registerShipmentItemTest extends SC_Helper_Purchase_TestBase
{
    ...
    // ///////////////////////////////////////
    public function testRegisterShipmentItem製品クラスIDが入っていない場合登録を行わない()
    {
        // 引数の設定
        $order_id = '1';
        $shipping_id = '1';
    ...
    public function testRegisterShipmentItem製品名等が指定されている場合指定された値で登録を行う()
    {
        // 引数の設定
    ...
    public function testRegisterShipmentItem製品名等が指定されていない場合DBからマスタ情報を取得して登録を行う()
    {
        // 引数の設定
        $order_id = $this->order_ids[0];
        $shipping_id = '1';
  ...
  // TODO 要確認price01, price02を設定しても価格が取れない。実際にはDBから取るケースが無い?
    ...
    public function testRegisterShipmentItemDBに存在しないカラムを指定した場合エラーなく登録できる()
    {
        // 引数の設定
        $order_id = '1';
        $shipping_id = '1';
