...
class SC_Utils_repeatStrWithSeparatorTest extends Common_TestCase
{
    ...
    // ///////////////////////////////////////
    public function testRepeatStrWithSeparator反復回数が0回の場合結果が0バイト文字列になる()
    {
        $this->expected = '';
    ...
    public function testRepeatStrWithSeparator反復回数が1回の場合区切り文字が入らない()
    {
        $this->expected = 'ECサイト';
    ...
    public function testRepeatStrWithSeparator反復回数が2回以上の場合区切り文字が入って出力される()
    {
    ...
    public function testRepeatStrWithSeparator区切り文字が未指定の場合カンマ区切りとなる()
    {
