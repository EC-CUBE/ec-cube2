...
class SC_Utils_sfGetProductClassIdTest extends Common_TestCase
{
    ...
    // ///////////////////////////////////////
    public function testSfGetProductClassId存在する製品IDのみを指定した場合カテゴリ0の対応する製品クラスが取得できる()
    {
        $this->expected = '2001';
    ...
    public function testSfGetProductClassId存在する製品IDのみを指定してカテゴリ0の製品クラスが存在しなければNullが返る()
    {
        $this->expected = null;
    ...
    public function testSfGetProductClassId存在する製品IDとカテゴリIDを指定した場合対応する製品クラスが取得できる()
    {
        $this->expected = '1002';
    ...
    public function testSfGetProductClassId存在する製品IDと存在しないカテゴリIDを指定した場合Nullが返る()
    {
        $this->expected = null;
    ...
    public function testSfGetProductClassId存在しない製品IDを指定した場合Nullが返る()
    {
        $this->expected = null;
