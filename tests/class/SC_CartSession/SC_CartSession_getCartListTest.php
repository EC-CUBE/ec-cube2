...
class SC_CartSession_getCartListTest extends SC_CartSession_TestBase
{
    ...
    public function testGetCartList商品を追加していなければ空の配列を返す()
    {
    ...
    public function testGetCartList商品を1つ追加した場合1つの配列を返す()
    {
        $this->setUpProductClass();
        // $this->setUpProducts();
        // $this->setUpClassCategory();
    ...
    /**
     * @depends testGetCartList商品を1つ追加した場合1つの配列を返す
     */
    public function testGetCartList商品を1つ追加した場合合計数は1($cartList)
    {
        $this->expected = 1;
    ...
    public function testGetCartList削除済み商品を追加した場合はカートは空()
    {
        $this->setUpProductClass();
        // $this->setUpProducts();
        // $this->setUpClassCategory();
    ...
    public function testGetCartList複数商品種別の30商品を追加した場合カートに30商品追加されている()
    {
