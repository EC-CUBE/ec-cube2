...
class LC_Page_Admin_Products_ProductClass_Test extends PHPUnit_Framework_TestCase 
{
    ...
    function setUp()
    {
        $this->markTestIncomplete('objPage->createSearchParams() は未実装です');
    ...
    {
        $this->markTestIncomplete('createSearchParams は実装されていません');
    ...
    {
        $this->markTestIncomplete('getProductsClassAndClasscategory は実装されていません');
        $product_id = 10000;
